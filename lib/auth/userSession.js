...
class UserSession {
     ...
     */
    redirectToSignIn() {
        return authApp_1.redirectToSignInImpl(this);
    }
    /**
    ...
    redirectToSignInWithAuthRequest(authRequest) {
        return authApp_1.redirectToSignInWithAuthRequestImpl(this, authRequest);
    }
    /**
     ...
     * @private
     */
    makeAuthRequest(transitKey, expiresAt = utils_1.nextHour().getTime(), extraParams = {}) {
    ...
    generateAndStoreTransitKey() {
        ...
        const transitKey = authMessages_1.generateTransitKey();
    ...
    handlePendingSignIn(authResponseToken = this.getAuthResponseToken()) {
        return authApp_1.handlePendingSignInImpl(this, authResponseToken);
    }
    /**
     ...
     */
    loadUserData() {
        return authApp_1.loadUserDataImpl(this);
    }
    /**
     * Sign the user out
     * @return {void}
    ...
    encryptContent(content, options) {
        return storage_1.encryptContentImpl(this, content, options);
    }
    /**
    ...
    decryptContent(content, options) {
        return storage_1.decryptContentImpl(this, content, options);
    }
    /**
    ...
    putFile(path, content, options) {
        return storage_1.putFileImpl(this, path, content, options);
    }
    /**
    ...
    getFile(path, options) {
        return storage_1.getFileImpl(this, path, options);
    }
    /**
    ...
    getFileUrl(path, options) {
        return storage_1.getFileUrlImpl(this, path, options);
    }
    /**
     ...
     */
    listFiles(callback) {
        return storage_1.listFilesImpl(this, callback);
    }
    /**
